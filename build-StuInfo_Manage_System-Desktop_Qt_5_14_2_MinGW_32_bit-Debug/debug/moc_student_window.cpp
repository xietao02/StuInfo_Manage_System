...
#include <memory>
#include "../../StuInfo_Manage_System/student_window.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Student_Window_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Student_Window_t qt_meta_stringdata_Student_Window = {
    {
QT_MOC_LITERAL(0, 0, 14), // "Student_Window"
QT_MOC_LITERAL(1, 15, 4), // "init"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 14), // "load_ClassList"
QT_MOC_LITERAL(4, 36, 19) // "exit_button_clicked"

    },
    "Student_Window\0init\0\0load_ClassList\0"
    "exit_button_clicked"
};
...
void Student_Window::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Student_Window *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->init(); break;
        case 1: _t->load_ClassList(); break;
        ...
        {
            using _t = void (Student_Window::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Student_Window::init)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Student_Window::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_Student_Window.data,
